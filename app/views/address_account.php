...
<head>
    ...
    <link rel="stylesheet" href="../../public/css/address_account.css">
            ...
            <div class="wrap_content">
                ...
                <div class="content_right">
                    <div class="row wrap_content_address">
                        ...
                        <!-- <div class="col-lg-6 col-md-12 col-12 wrap_addAddress">
                            <a href="#" class="add-new-address">Nhập địa chỉ mới</a>
                            <div id="add_address" class="customer_address add_address add_address_table"
                                style="display:none;">
                                <form accept-charset="UTF-8" action="/account/addresses" id="address_form_new"
                                    method="post">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="address_last_name_new" class="input-textbox textbox"
                                            name="address[last_name]" size="40" value="" placeholder="Họ">
                                    </div>
                                    <div class="input-group">
                                        <span class="input-ico"><i class="fa fa-user-o"></i></span>
                                        <input type="text" id="address_first_name_new" class="input-textbox textbox"
                                            name="address[first_name]" size="40" value="" placeholder="Tên">
                                    </div>
                                    <div class="input-group">
                                        <span class="input-ico"><i class="fa fa-home"></i></span>
                                        <input type="text" id="address_address1_new" class="input-textbox textbox"
                                            name="address[address1]" size="40" value="" placeholder="Địa chỉ">
                                    </div>
                                    <div class="address">
                                        <div class="input-group" id="address_province_container_1125532830" style="">
                                            <div>
                                                <span class="input-ico"><i class="fa fa-map-marker"></i></span>

                                                <select id="province1" class="province-select input-textbox textbox"
                                                    name="province1">
                                        ...
                                        <div class="input-group" id="address_province_container_1125532830" style="">
                                            <div>
                                                ...
                                                <select id="district1" class="input-textbox textbox" name="district1">
                                        ...
                                        <div class="input-group" id="address_province_container_1125532830" style="">
                                            <div>
                                                ...
                                                <select class="input-textbox textbox" id="ward1" name="ward1">
                                    ...
                                    <div class="input-group" id="address_province_container_new" style="display:none">
                                        <span class="input-ico"><i class="glyphicon glyphicon-map-marker"></i></span>
                                        <select id="address_province_new" class="input-textbox textbox"
                                            name="address[province]" data-default=""></select>
                                    </div>
                                    <div class="input-group">
                                        <span class="input-ico"><i class="fa fa-phone"></i></span>
                                        <input type="text" id="address_phone_new" class="input-textbox textbox"
                                            name="address[phone]" size="40" value="" placeholder="Số điện thoại">
                                    </div>
                                    <div class="input-group">
                                        <input type="checkbox" id="address_default_address_new" name="address[default]"
                                            value="1"> Đặt làm địa chỉ mặc định.
                                    </div>
                                    <div class="action_bottom">
                                        <input class="btn btn-primary" type="submit" value="Thêm mới">
                                        <span class="">hoặc <a href="#">Hủy</a></span>
                                    </div>
                                </form>
                            </div>
                        </div> -->
