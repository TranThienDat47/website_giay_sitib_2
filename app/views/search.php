...
<body>
    ...
    <main class="main">
        <div class="layout-searchPage" id="layout-searchpage">
            <div class="searchPage__container">
                <div class="searchPage__heading-page">
                    <h1>Tìm kiếm</h1>
                    <p class="searchPage__subtxt">Có <strong>0 sản phẩm</strong> cho tìm kiếm</p>
                </div>
                <div class="searchPage__wrapbox-content">
                    <div class="searchPage__content" id="search">
                        <p class="searchPage__subtext-result">
                            Kết quả tìm kiếm cho
                            <strong>"Giày Thể Thao Nam Biti's Hunter X Festi"</strong>.
                        </p>
                        <div class="searchPage__search-list-results">
                            <!-- Begin results -->
                            <div class="searchPage__listProduct-row searchPage__listProduct-resize"></div>
                            <!-- End results -->
                        </div>
                        <div class="searchPage__pagination-shop text-center">
                            <div id="searchPage__pagination"></div>
                            <button style="display: none" id="nextPageSearch" class="btn btn-info">
                                XEM THÊM
                            </button>
                            <button type="hidden" style="display: none" id="tempPageSearch"
