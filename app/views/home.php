...
<body>
    ...
    <main class="main">
        ...
        <!-- ADS Banner -->
        <div class="ads-banner-block"></div>
        ...
        <!-- New -->
        <div class="new-block">
            <div class="title">Chúng tôi có gì mới</div>
            <div class="new-img-block"></div>
        </div>
    </main>

    <!-- Man collections -->
    <div class="man collection-container">
        <div>
            <div class="head-collection">
                <div class="category">
                    ...
                    <ul>
                        ...
                        $list_details = getChildCategory($db, '1');
                        echo $list_details;
                        ?>
                        <!-- <li class="type"><a href="#">Hunter</a></li>
                        <li class="type"><a href="#">Sandal</a></li>
                        <li class="type"><a href="#">Giày Thể Thao</a></li>
                        <li class="type"><a href="#">Giày Chạy Bộ</a></li>
                        <li class="type"><a href="#">Giày Đá Banh</a></li>
                        <li class="type"><a href="#">Giày Tây</a></li>
                        <li class="type"><a href="#">Dép</a></li> -->
                    </ul>
                </div>
                <div class="divider"></div>
            </div>
            <div class="product-collection">
                <div id="prdZone__man" class="prd-zone">
                    <div class="prd-zone__item"></div>
                </div>
                <div class="cta-btn">
    ...
    <!-- Woman collections -->
    <div class="woman collection-container">
        <div class="head-collection">
            <div class="category">
                ...
                <ul>
                    ...
                    $list_details = getChildCategory($db, '2');
                    echo $list_details;
                    ?>
                    <!-- <li class="type"><a href="#">Hunter</a></li>
                    <li class="type"><a href="#">Sandal</a></li>
                    <li class="type"><a href="#">Giày Búp Bê</a></li>
                    <li class="type"><a href="#">Giày Thời trang</a></li>
                    <li class="type"><a href="#">Giày Chạy</a></li>
                    <li class="type"><a href="#">Giày Thể thao nữ</a></li>
                    <li class="type"><a href="#">Dép</a></li> -->
                </ul>
            </div>
            <div class="divider"></div>
        ...
        <div class="product-collection">
            <div id="prdZone__woman" id="prdZone__woman" class="prd-zone">
                <div class="prd-zone__item"></div>
            </div>
            <div class="cta-btn">
                <!-- <a href="#">Còn nhiều lắm, xem thêm</a>
