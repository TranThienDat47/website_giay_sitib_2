...
<head>
    ...
    <link rel="stylesheet" href="../../public/css/edit_information_account.css">
        ...
        <div class="container">
            <div class="wrap_content">
                ...
                <div class="content_right">
                    ...
                    <?php
                    //khi có submit thì xu ly update, CHƯA ĐƯỢC TỐI ƯU VÌ NẾU CÓ NHIỀU CHỨC NĂNG PHỨC TẠP THÌ TOANG
                    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                        $userController = new CustommerController();
                        if ($userController->updateCustomer() == true) {
                    ...
                    <div class="update_accout user_box">
                        <form method="POST" id="extraInfo">
                            <div class="mb-3">
                                <label>Họ:</label>
                                <input class="form-control" value="<?= $id ?>" name="id" hidden />
                                <input class="form-control" autocomplete="off" required=""
                                    data-errormessage-value-missing="Bạn chưa nhập Họ" type="text"
                                    value="<?= $customer->getFirstName() ?>" name="last_name" placeholder="Nhập họ (*)"
                                    id="last_name" size="30" />
                            </div>
                            <div class="mb-3">
                                <label>Tên:</label>
                                <input class="form-control" autocomplete="off" required=""
                                    data-errormessage-value-missing="Bạn chưa nhập Tên" type="text"
                                    value="<?= $customer->getLastName() ?>" name="first_name" placeholder="Nhập tên (*)"
                                    id="first_name" size="30" />
                            </div>

                            <div id="field-gender" class="gioitinh">
                                <label> Giới tính:</label><br>
                                <input id="radio1" type="radio" value="Nữ" <?php if ($customer->getGender() == 'Nữ')
                                    echo 'checked' ?> name="gender" />
                                    <label for="radio1">Nữ</label>
                                    <input id="radio2" type="radio" value="Nam" <?php if ($customer->getGender() == 'Nam')
                                    echo 'checked' ?> name="gender" />
                                ...
                                <div class="mb-3">
                                    <label>Email:</label>
                                    <input class="form-control" autocomplete="off" required=""
                                        data-errormessage-value-missing="Bạn chưa nhập email"
                                        data-errormessage-type-mismatch="Email chưa đúng định dạng!" type="email"
                                        value="<?= $customer->getEmail() ?>" placeholder="Nhập email (*)" name="email"
                                    id="email" size="30" readonly />
                            </div>
                            <div class="mb-3">
                                <label>Mật khẩu:</label>
                                <input class="form-control" autocomplete="off" required=""
                                    data-errormessage-value-missing="" data-errormessage-type-mismatch="" type="tel"
                                    value="<?= $customer->getPassword() ?>" placeholder="Mật Khẩu" name="mk" id="mk"
                                    size="30" />
                            </div>

                            <div class="mb-3">
                                <label>Số điện thoại:</label>
                                <input class="form-control" autocomplete="off" pattern="[0-9]{10}" required=""
                                    data-errormessage-value-missing="Bạn chưa nhập số điện thoại"
                                    data-errormessage-type-mismatch="Số điện thoại chưa đúng định dạng!" type="tel"
                                    value="<?= $phone ?>" placeholder="Số điện thoại (*)" name="phone" id="phone_ac"
                                    size="30" readonly />
                            </div>

                            <div id="diachi" class="mb-3">
                                <label>Địa chỉ:</label>
                                <input class="form-control" autocomplete="off" type="text" required=""
                                    value="<?= $address ?>" placeholder="Địa chỉ" name="staff_address"
                                    id="staff_address" size="30" readonly />
                            </div>
                            ...
                            <div class="action_bottom action_link text-center">
                                <input class="btn button m-b-10" type="submit" value="Cập nhật" />
                            </div>
                        </form>
...
<script type="module" src='../../public/js/address_account.js'></script>
