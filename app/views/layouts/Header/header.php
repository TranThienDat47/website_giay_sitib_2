                        ...
                        <ul class='header__main-menuList-primary'>
                            ...
                            <li class='header__main-has-submenu'>
                                ...
                                <ul class='header__main-menuList-submain'>
                                    ...
                                    <li class=''>
                                        <a href='/collections/nam/index.html?collection=nu&type=sandal-nu-1'>
                                            Sandal
                                        </a>
                                    </li>
                                    <li class=''>
                                        <a href='/collections/nam/index.html?collection=nu&type=giay-bup-be-nu'>
                                            Giày Búp Bê
                                        </a>
                                    </li>
                                    <li class=''>
                                        <a href='/collections/nam/index.html?collection=nu&type=giay-thoi-trang-nu-1'>
                                            Giày Thời Trang
                                        </a>
                                    </li>
                                    <li class=''>
                                        <a href='/collections/nam/index.html?collection=nu&type=hunter-running-jogging'>
                                            Giày Chạy Bộ - Đi Bộ
                                        </a>
                                    </li>
                                    <li class=''>
                                        <a href='/collections/nam/index.html?collection=nu&type=giay-the-thao-nu'>
                                            Giày Thể Thao Nữ
                                        </a>
                                    </li>
                                    <li class=''>
                                    ...
                                    <li class=''>
                                        <a href='/collections/nam/index.html?collection=nu&type=tui-xach'>
                                            Túi xách
                                        </a>
                                    </li>
                                </ul>
                    ...
                    <div class='header__action-inner'>
                        ...
                        <div class='header__action-item header__action-account'>
                            <div class='header__action-item-text'>
                                <div class='header__action-item-link' id='site-account-handle' aria-label='Tài khoản'
                                    title='Tài khoản'>
                                    <span class='box-icon'>
                                            ...
                                            <form accept-charset='UTF-8' id='customer_login'>
                                                ...
                                                <div class='form__input-wrapper form__input-wrapper--labelled'>
                                                    <input type='password' id='login-customer[password]'
                                                        class='form__field form__field--text' name='customer_password'
                        ...
                        <div class='header__action-item header__action-cart'>
                            <div class='header__action-item-text'>
                                <div class='header__action-item-link header__action-item-clicked' id='site-cart-handle'
