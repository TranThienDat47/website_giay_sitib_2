        ...
        <div class="container">
            <div class="heading-account">
                <div class="content-center">
                    <h2>Đăng nhập</h2>
                    <h2><a href="./register.php">Đăng ký</a></h2>
                </div>
            </div>
            ...
            <div class="content-account">
                <div class="customer_login">
                    <div class="form_login">
                        <!-- <div class='errors'>
                            <h2>Thông tin đăng nhập không hợp lệ.</h2>
                        </div> -->

                        <?php
                        if (isset($login_check)) {
                            echo "<h4 style='color: red;'>$login_check</h4>";
                        }
                        ?>
                        ...
                        <form action="login.php" method="post">
                            ...
                            <input name="email" type="text" id="taikhoan" placeholder="Vui Lòng Nhập Email Của Bạn" />
                            <div class="title">
                                <h2>Mật Khẩu</h2>
                            </div>
                            <input name="password" type="password" id="matkhau" placeholder="Vui Lòng Nhập Mật Khẩu" />
                            <div class="account__show-hide-password" style="
                              display: flex;
                           ...
                           ">
                                ...
                                <input style="width: 18px; height: 18px; margin: 0 0 0 8px" id="showPassword"
                                    type="checkbox" value="Hiện mật khẩu" />
                            </div>
                            <!-- button -->
                            <div class="account-action">
                                <button type="submit" class="login_btn" id="dangnhap"> Đăng nhập </button>
                                <div class="req_pass">
                                    Bạn chưa có tài khoản?
                                    <a href="./register.php" id="dangki" title="Đăng ký">Đăng ký ngay</a><br />
                                    Bạn quên mật khẩu? <a href="#" id="req_pas">Khôi phục mật khẩu</a>
                                </div>
                            </div>
                        </form>
                    </div>

                    <div class="recover_pass_form">
                        <div class="title_big">
                        ...
                        <form action="">
                            ...
                            <input type="text" id="tf_email_repass" placeholder="Email" />
                            ...
                            <!-- button -->
                            <div class="account-action">
                                <button type="button" class="btn_re_pas">Gửi</button>
                                <h2 id="cancer_repass">Hủy</h2>
                            </div>
                        </form>
                    </div>
                </div>
